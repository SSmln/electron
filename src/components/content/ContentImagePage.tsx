import styles from './ContentImagePage.module.css';
...
const TopImage = (props) => {
    ...
    return (
        <div className={styles.contentImg__TopImg} onClick={onClickHandler}>
                ...
                <TreeItem nodeId="1" label="Image classification">
                    <TreeItem nodeId="1_1" label="resnet">
                        <TreeItem
                            ...
                            nodeId="1_1_1"
                            label="classification_resnet18"
                        />
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="1_1_2"
                            label="classification_resnet34"
                        />
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="1_1_3"
                            label="classification_resnet50"
                        />
                    </TreeItem>
                    <TreeItem nodeId="1_2" label="efficientnet">
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="1_2_1"
                            label="classification_efficientnetb0"
                        />
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="1_2_2"
                            label="classification_efficientnetb1"
                        />
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="1_2_3"
                            label="classification_efficientnetb2"
                        />
                    </TreeItem>
                </TreeItem>
                <TreeItem nodeId="2" label="Object detection">
                    <TreeItem nodeId="2_1" label="yolo">
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="2_1_1"
                            label="detection_yolov5"
                        />
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="2_1_2"
                            label="detection_yolov7"
                        />
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="2_1_3"
                            label="detection_yolov8"
                        />
                    </TreeItem>
                </TreeItem>
                <TreeItem nodeId="3" label="Semantic segmentation">
                    <TreeItem nodeId="3_1" label="deeplab">
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="3_1_1"
                            label="semantic_deeplabv3"
                        />
                        <TreeItem
                            onClick={itemClickHandler}
                            nodeId="3_1_2"
                            label="semantic_deeplabv3plus"
                        />
                    </TreeItem>
                </TreeItem>
            </TreeView>
...
function ContentImagePage() {
    ...
    const clickedImg = useSelector(
        (state) => state.data.contentFile.clickedImg,
    );
    const inferenceImg = useSelector(
        (state) => state.data.contentFile.inferenceImg,
    );
    ...
    return (
        <div className={styles.contentImg}>
            <div
                className={
                    open
                        ? styles.contentImg__Main__hide
                        : styles.contentImg__Main__open
                }
            >
                ...
                <div className={styles.contentImg__View}>
                    <div className={styles.contentImg__ViewLeft}>
                        <img src={clickedImg} alt="original image" />
                        입력 이미지
                    </div>
            ...
            출력 이미지
                    ...
                    <div className={styles.contentImg__ViewRight}>
                        <img src={concatImg} alt="concat result" />
                        합성 이미지
                    </div>
                </div>
            </div>
            <div
                className={open ? styles.asidebar__open : styles.asidebar__hide}
            >
                <AsideBar />
            </div>
        </div>
