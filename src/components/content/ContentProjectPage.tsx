...
function ContentProjectPage() {
    ...
    const currentIdx = useSelector(
        (state) => state.data.contentProject.clickedIdx,
    );
    const tabComponents = useSelector(
        (state) => state.data.contentProject.tabComponents,
    );
    const addProject = useSelector(
        (state) => state.data.contentProject.addProject,
    );
